...
!function (a) {
    ...
    a.extend(a.fn, {
        ...
        messages: {
            ...
            rangelength: a.validator.format("Por favor introduzca un valor entre {0} y {1} caracteres de longitud."),
            range: a.validator.format("Por favor introduzca un valor entre {0} y {1}."),
            max: a.validator.format("Por favor introduzca un valor inferior o igual a {0}."),
            min: a.validator.format("Por favor introduzca un valor superior o igual a {0}."),
